...
import { navigate_to } from "../resources/navigate";
...
export default function NavBar() {
    ...
    return (
        <div className="mx-10">
            <div className="flex justify-center items-center" onClick={() => navigate_to("/cart")}>
            ...
            <ul className="flex justify-between rounded-full px-5 py-3 mx-5 bg-highlightRed">
                {
                    ...
                    text-black font-normal" onClick={() => navigate_to(route)}> {name} </li>))
                }
            </ul>
        </div>
    )
